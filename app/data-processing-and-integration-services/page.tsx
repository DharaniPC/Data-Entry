    ...
    return (
        <main>
            ...
            <section>
                <div className="w-full flex justify-center px-6 py-15 bg-gray-50">
                    <div className="max-w-7xl space-y-6">
                        <h2 className="text-3xl font-bold">Transform Data Chaos into a Cohesive Business Asset</h2>
            ...
            <section>
                <div className="w-full flex gap-10 justify-center py-15">
                    <div className="max-w-7xl text-center">
                        ...
                        <p className="mb-8">We turn disparate data into your most valuable strategic tool.</p>
            ...
            <section >
                <div className="w-full flex justify-center px-6 py-15 bg-gray-50">
                    <div className="max-w-7xl space-y-6">
                        <h2 className="text-3xl font-bold text-center">Why Choose Our Data Processing & Integration Services?</h2>
            ...
            <section>
                <div className="w-full flex gap-10 items-center justify-center py-15">
                    <div className="max-w-7xl text-center">
                        ...
                        <p className="mb-8">Simplify Your Data Ecosystem in 3 Easy Steps</p>
