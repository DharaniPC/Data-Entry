...
export default function Footer() {
  return (
    <footer className="bg-black text-white">
      <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-8 md:gap-10 justify-between">
        {/* Logo */}
        <div className="w-full md:w-[30%] pb-8 border-b border-gray-300 md:border-none">
          <Link href="/">
        ...
        <div className="w-full md:w-[35%]  pb-8 border-b border-gray-300 md:border-none">
        ...
        {/* Menu - vertical */}
        <div className="text-sm flex flex-col items-start w-full md:w-[35%]">
