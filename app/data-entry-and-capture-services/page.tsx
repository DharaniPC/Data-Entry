    ...
    return (
        <main>
            ...
            <section >
                <div className="w-full flex justify-center px-6 py-15 bg-gray-50">
                    <div className="max-w-7xl space-y-6">
                        <h2 className="text-3xl font-bold">Precision at Your Fingertips</h2>
            ...
            <section>
                <div className="w-full flex gap-10 justify-center py-15">
                    <div className="max-w-7xl text-center">
                        ...
                        <p className="mb-8">We provide a full spectrum of services to turn data chaos into clarity</p>
            ...
            <section >
                <div className="w-full flex justify-center px-6 py-15 bg-gray-50">
                    <div className="max-w-7xl space-y-6">
                        <h2 className="text-3xl font-bold text-center">Why Choose Us as Your Data Entry & Capture Partner?</h2>
            ...
            <section>
                <div className="w-full flex gap-10 items-center justify-center py-15">
                    <div className="max-w-7xl text-center">
                        ...
                        <p className="mb-8">Simplify Your Data Management in 3 Steps</p>
